...
# validation function
def general_validation(args, input2output, input_tensor2string, valid_loader, validset_len, model_name, trainset, patentset):
    with torch.no_grad():
        results_file_path = args.plots_folder + '/' + args.enhanced_property + '/' + args.enhanced_property + '_validation.txt'
        valid_results_file_path = args.plots_folder + '/' + args.enhanced_property + '/valid_' + args.enhanced_property + '_validation.txt'
